...
SRC_URI="
	$(cargo_crate_uris)
	https://github.com/getzola/${PN}/archive/refs/tags/v${PV}.tar.gz
"

# License set may be more restrictive as OR is not respected
# use cargo-license for a more accurate license picture
LICENSE="(Apache-2.0 (MIT 0BSD Apache-2.0 Apache-2.0) Apache-2.0-with-LLVM-exceptions BSD BSD-2 Boost-1.0 CC0-1.0 ISC MIT MIT) MPL-2.0 Unicode-DFS-2016 Unlicense ZLIB"
SLOT="0"
KEYWORDS="amd64"
